"""
Smart AI Dog Robot - HYBRID FACE RECOGNITION VERSION

Hybrid face recognition flow:

1. Trained TensorFlow model:
   models/face_model.keras
   models/class_indices.json

2. If trained model is not confident:
   old enrollment database system is used.

So:
- Dataset trained people -> recognized by trained model
- Newly enrolled people -> recognized by database
- Others -> UNKNOWN
"""
...
class SmartAIDogRobot:
    def __init__(self):
        print("=" * 50)
        print("🐶 SMART AI DOG ROBOT - HYBRID FACE RECOGNITION")
        print("=" * 50)
    ...
    def draw_emotion_details(self, frame, x, y, all_emotions):
        """Draw detailed emotion percentages"""
        if not all_emotions:
            return frame
    ...
    def recognize_hybrid(self, face_img):
        ...
        1. First try trained TensorFlow model.
        2. If model is not confident, try old enrolled database.
        3. If both fail, return UNKNOWN.

        Returns:
            name, score_percent, source
        """
        ...
        # Step 2: old enrollment database fallback
    ...
    def process_frame(self, frame):
        """Process single frame with hybrid face recognition and emotion detection"""
    ...
    def run(self):
        ...
        print("🚀 Running with hybrid recognition")
        ...
        while True:
            ...
            cv2.imshow(
                "Smart AI Dog Robot - Hybrid Face + Emotion Detection",
                display_frame
            )
    ...
    def complete_enrollment(self):
        """
        Complete enrollment and save new person to old database system.

        This is still needed because hybrid system supports:
        - trained model persons
        - newly enrolled persons
        """
